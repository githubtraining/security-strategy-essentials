...
<h1 align="center">Course: Security strategy essentials </h1>

This repository powers the Learning Lab course [_Security strategy essentials_](https://lab.github.com/githubtraining/security-strategy-essentials).

Every Learning Lab course is made up of:
- a [course repository](https://github.com/githubtraining/security-strategy-essentials), and
- a [template repository](https://github.com/githubtraining/security-strategy-essentials-template)
